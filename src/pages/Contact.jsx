    ...
    <div className="min-h-screen bg-[#ECF5F0]">
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          <a href="tel:0756986001" className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center gap-4 group">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-[#E95678]">07 56 98 60 01</p>
              <p className="text-sm text-slate-500 mt-1">Appelez-nous directement</p>
            </div>
          </a>

          <a href="mailto:contact@naky.fr" className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center gap-4 group">
            <div className="w-16 h-16 bg-[#E95678]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#E95678]/20 transition-colors">
              <Mail className="w-8 h-8 text-[#E95678]" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-900 mb-1">Email</h3>
              <p className="text-xl font-semibold text-[#E95678]">contact@naky.fr</p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm flex flex-col items-center text-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-700 font-medium">Région parisienne</p>
              <p className="text-sm text-slate-500 mt-1">Paris & Île-de-France</p>
            </div>
          </div>
