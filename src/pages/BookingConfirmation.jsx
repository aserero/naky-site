          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-slate-900">{getServiceLabel(bookingDetails.service_type)}</p>
                  <p className="text-sm text-slate-600">Durée : {bookingDetails.duration}</p>
                </div>
              </div>
              ...
              {bookingDetails.total_price && (
                <div className="pt-4 border-t">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-[#E95678]">{bookingDetails.total_price}€</span>
                  </div>
                </div>
              )}
            </div>
