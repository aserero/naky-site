      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto">
            Naky, c'est le service de ménage à domicile pensé pour vous : rapide, fiable et humain. Nous connectons les particuliers avec des agents de ménage professionnels, partout en région parisienne — en quelques clics seulement.
          </p>
          <div className="mt-8">
            <Link to="/Booking">
